...
NSString *const PSMDeserializationErrorDomainKey = @"PSMDeserializationErrorDomainKey";

NSInteger const PSMTypeMismatchErrorCode = 143553;

NSInteger const PSMEmptyValueOccurredErrorCode = 143509;

NSInteger const PSMUnknownResponseObjectErrorCode = 143528;


@interface PSMResponseDeserializer ()
...
@implementation PSMResponseDeserializer
...
-(NSError *)typeMismatchErrorWithExpectedType:(NSString *)expected data:(id)data {
    ...
    return [NSError errorWithDomain:PSMDeserializationErrorDomainKey code:PSMTypeMismatchErrorCode userInfo:userInfo];
}
...
-(NSError *)emptyValueOccurredError {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:PSMDeserializationErrorDomainKey code:PSMEmptyValueOccurredErrorCode userInfo:userInfo];
}
...
-(NSError *)unknownResponseErrorWithExpectedType:(NSString *)expected data:(id)data  {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:PSMDeserializationErrorDomainKey code:PSMUnknownResponseObjectErrorCode userInfo:userInfo];
}
