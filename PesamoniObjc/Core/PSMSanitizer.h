...
extern NSString * PSMPercentEscapedStringFromString(NSString *string);

extern NSString * const kPSMApplicationJSONType;

@protocol PSMSanitizer <NSObject>
...
@interface PSMSanitizer : NSObject <PSMSanitizer>
